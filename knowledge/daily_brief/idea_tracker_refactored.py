...
class Idea:
    ...
    def values(self):
        return [self.id, self.source, self.text, self.category, self.status,
                self.score, self.linked_trajectories, self.impact_score,
                self.created_at, self.tested_at, self.evaluated_at, self.tags]
