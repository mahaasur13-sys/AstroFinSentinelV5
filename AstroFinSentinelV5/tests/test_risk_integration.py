...
def clean_env():
    for k in ["SAFETY_STACK_ENABLED","RISK_ENGINE_V2_ENABLED","EXECUTION_SANITY_ENABLED","MARKET_MODE"]:
...
class TestRiskEngineIntegration:
    ...
    def test_reduced_on_high_exposure(self, safety_gate, risk_engine, minimal_state):
        ...
        risk_engine._positions["BTCUSDT"] = type("P", (), {"symbol": "BTCUSDT", "notional_value": 8000.0, "unrealized_pnl": 0.0})()
