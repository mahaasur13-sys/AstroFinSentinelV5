...
class RelevanceScore:
    ...
    HIGH_RELEVANCE = {
        "multi-agent", "mas factory", "agent orchestration", "agent coordination",
        "thompson sampling", "reward function", "reward shaping", "oap",
        "self-improvement", "meta-reasoning", "karma", "self-questioning",
        "uncertainty", "grounding", "confidence calibration", "position sizing",
        "agent topology", "switch node", "merge node", "sequential node",
        "parallel node", "hierarchical", "ensemble", "voting",
        "crewai", "autogen", "pressure field", "temporal decay",
    }
    
    MEDIUM_RELEVANCE = {
        "agent", "llm", "language model", "pipeline", "workflow",
        "async", "parallel", "orchestration", "framework", "tool",
        "api", "integration", "monitoring", "visualization", "dashboard",
        "backtest", "trading", "signal", "confidence", "decision",
        "arxiv", "research", "paper", "coordination",
    }
    
    LOW_RELEVANCE = {
        "marketing", "community", "social media", "post", "tweet",
        "hacker news", "reddit", "opinion", "speculation",
    }
...
class DigestAnalyzer:
    ...
    CATEGORY_KEYWORDS = {
        Category.TOOLS_AND_FRAMEWORKS: [
            "framework", "library", "tool", "release", "github", "package",
            "sdk", "api", "module", "plugin", "extension", "crewai", "autogen",
        ],
        Category.ARCHITECTURE_PATTERNS: [
            "architecture", "design pattern", "mas factory", "topology",
            "switch node", "merge node", "sequential", "parallel",
            "agent orchestration", "workflow", "pipeline", "routing",
            "hierarchical", "multi-agent", "coordination", "pressure field",
        ],
        Category.RL_OAP_REWARD: [
            "reinforcement learning", "reward", "rl", "oap", "optimization",
            "policy", "training", "trajectory", "backprop", "gradient",
            "self-improvement", "meta-learning", "calibration", "temporal decay",
        ],
        Category.VISUALIZATION: [
            "visualization", "dashboard", "monitoring", "debugging",
            "tracing", "logging", "metrics", "observability", "ui",
        ],
        Category.DATABASE: [
            "database", "postgresql", "sqlite", "persistence", "storage",
            "cache", "caching", "query", "schema", "migration",
        ],
        Category.DEPLOYMENT: [
            "deployment", "production", "scaling", "kubernetes", "docker",
            "ci/cd", "infrastructure", "cloud", "serverless",
        ],
    }
    
    def __init__(self, digest_path: str = None):
        self.digest_path = digest_path
        self.current_analysis: Optional[DigestAnalysis] = None
