...
def generate_html_report(result, output_path="data/karl_report.html"):
    ...
    html = """<!DOCTYPE html><html><head><meta charset=utf-8><title>ATOM-017 KARL Report</title>"""
    html += """<style>body{font-family:-apple-system,sans-serif;background:#0f172a;color:#e2e8f0;padding:20px}"""
    ...
    html += """<body><div class="container"><h1>AstroFin Sentinel v5 — KARL Report</h1>"""
