            ...
            dbc.Col([
                dbc.Card([
                    ...
                    dbc.CardBody([
                        ...
                        html.Hr(),
                        dbc.Row([
                            dbc.Col(html.Span("Sessions: "), width="auto"),
                            dbc.Col(html.Span(id="live-sessions-count", children="—"), width="auto"),
                        ]),
                        dbc.Row([
                            dbc.Col(html.Span("Strategies: "), width="auto"),
                            dbc.Col(html.Span(id="live-strategies-count", children="—"), width="auto"),
                        ]),
                        dbc.Row([
                            dbc.Col(html.Span("Last update: "), width="auto"),
                            dbc.Col(html.Span(id="live-last-update", children="—"), width="auto"),
                        ]),
                    ]),
                ])
            ], width=4),
