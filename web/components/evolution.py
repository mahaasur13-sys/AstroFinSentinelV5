    ...
    return html.Div([
        ...
        dbc.Card([
            dbc.CardHeader([
                ...
                html.Span(id="evolution-status", children="Idle", className="ms-3 text-info fw-bold"),
            ]),
            dbc.CardBody([
                # Progress Bar
                dbc.Progress(
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        html.Br(),
                        html.Span(id="progress-pct", children="0%", className="fw-bold fs-5")
                    ], width=2),

                    dbc.Col([
                        html.Small("Generation", className="text-muted"),
                        html.Br(),
                        html.Span(id="current-gen-display", children="—", className="fw-bold text-info fs-5")
                    ], width=2),

                    dbc.Col([
                        html.Small("Best Reward", className="text-muted"),
                        html.Br(),
                        html.Span(id="best-reward-display", children="—", className="fw-bold text-success fs-5")
                    ], width=2),

                    dbc.Col([
                        html.Small("Δ Best", className="text-muted"),
                        html.Br(),
                        html.Span(id="delta-best-display", children="—", className="fw-bold")
                    ], width=2),

                    dbc.Col([
                        html.Small("Mean ± Std", className="text-muted"),
                        html.Br(),
                        html.Span(id="mean-std-display", children="—", className="fw-bold")
                    ], width=2),

                    dbc.Col([
                        html.Small("KARL Q*", className="text-muted"),
                        html.Br(),
                        html.Span(id="karl-qstar-display", children="—", className="fw-bold text-info")
                    ], width=1),

                    dbc.Col([
                        html.Small("Diversity", className="text-muted"),
                        html.Br(),
                        html.Span(id="diversity-display", children="—", className="fw-bold text-warning")
                    ], width=1),
