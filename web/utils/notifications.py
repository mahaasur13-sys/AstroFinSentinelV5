...
def make_toast(
    ...
    return dbc.Toast(
        [
            html.Div([
                html.I(className=icon_class, style={"fontSize": "1.1rem", "marginRight": "8px"}),
...
def make_toast_container(toasts: list) -> html.Div:
    ...
    return html.Div(toasts, id="toast-container", style={"position": "fixed", "top": 70, "right": 20, "zIndex": 9999})
